				...
				<div class="col-md-4 login-sec">
					...
					<table>
						<s:form action="loginAction" method="post">
							<tr>
								<td>&nbsp;&nbsp;&nbsp;<s:textfield cssClass="form-control col-sm-12" label="E-Mail" name="email"></s:textfield></td>
							</tr>
							<tr>
								<td>&nbsp;&nbsp;&nbsp;<s:password cssClass="form-control col-sm-12" label="Password" name="password"></s:password></td>
							</tr>
							<tr>
							...
							<tr style="align: center;">
								<td colspan="2">&nbsp;&nbsp;&nbsp; <s:a style="align:center;" href="register.jsp" cssClass="btnForgetPwd">Register</s:a></td>
							</tr>
						</s:form>
					</table>
				</div>
